...
image:https://travis-ci.com/GaLaXy102/videoshop.svg?branch=master["Build Status", link="https://travis-ci.com/GaLaXy102/videoshop"]
...
My personal extension (WIP) is the possibility to buy and redeem gift vouchers.
